...
{
    public sealed class DynamicJsonConverter : Newtonsoft.Json.JsonConverter {
        ...
        public IEnumerable<Type> SupportedTypes => new ReadOnlyCollection<Type>(new List<Type>(new[] { typeof(object) }));
